...
const Import = () => {
  ...
  const handleFileUpload = (e) => {
    ...
    if (invalidImage) {
      alert(
        `Image "${invalidImage.name}" exceeds the 5MB limit.`
      );
    ...
    reader.onload = (event) => {
      try {
        ...
        if (jsonData.length === 0) {
          alert(
            "The Excel file does not contain any product data."
          );
        ...
        alert(
          "Failed to parse XLS file. Please verify the format."
        );
      }
    };
    ...
    <div className="importXls">
      ...
      <div className="importXls-header">
        ...
        <div className="importXls-breadcrumb">
          ...
          <span className="importXls-breadcrumbActive">
            Import XLS
          </span>
        ...
        <main className="importXls-main">
          ...
          {!imported ? (
            ...
            <div className="importXls-uploadBox">
              ...
              <div className="importXls-uploadIcon">
                📊
              </div>
              ...
              <p>
                Upload your .xls or .xlsx spreadsheet file
              </p>
            ...
            <>
              ...
              <div className="importXls-successCard">
                ...
                <div className="importXls-successCardLeft">
                  ...
                  <div className="importXls-successIcon">
                    ✓
                  </div>
                  ...
                  <div className="importXls-fileMeta">
                    ...
                    <div className="importXls-fileStats">
                      ...
                      <span className="importXls-statDivider">
                        |
                      </span>
                        ...
                        >
                          ...
                          <td>
                            ...
                            {row.valid ? (
                              ...
                              <span className="importXls-badgeValid">
                                Valid
                              </span>
              ...
              {invalidRowsCount >
                ...
                <div className="importXls-warningBox">
                  ...
                  <span className="importXls-warningIcon">
                    !
                  </span>
                  ...
                  <p>
                    ...
                    rows contain invalid
                    data and will not be
                    imported.
                  </p>
        ...
        <aside className="importXls-sidebar">
          ...
          <div className="importXls-infoCard importXls-helpCard">
            ...
            <div className="importXls-helpHeader">
              ...
              <div className="importXls-helpIcon">
                !
              </div>
            ...
            <p>
              Download the sample file and follow
              the format to import data correctly.
            </p>
